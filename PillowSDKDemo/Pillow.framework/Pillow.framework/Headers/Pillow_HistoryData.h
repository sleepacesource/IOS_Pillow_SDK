...
typedef NS_ENUM(NSInteger,Pillow_ScoreDeductibleTypes) {
    Pillow_ScoreDeductibleType_BodyMoveToomuch = 0,//躁动不安
    Pillow_ScoreDeductibleType_LeftBedToomany,//睡觉起夜， 离床次数过多
    Pillow_ScoreDeductibleType_AwakeTooFrequent,//睡觉易醒 , 清醒次数过多
    Pillow_ScoreDeductibleType_SleepToolate,//太晚睡觉
    Pillow_ScoreDeductibleType_DifficultToSleep,//太难入睡
    Pillow_ScoreDeductibleType_DeepSleepNotEnough,//深睡眠不足
    Pillow_ScoreDeductibleType_SleepTooLong,//实际睡眠时长过长
    Pillow_ScoreDeductibleType_SleepTooShort,//实际睡眠时长太短
    Pillow_ScoreDeductibleType_BreathPause,//呼吸暂停
    Pillow_ScoreDeductibleType_HeartbeatPause,//心跳暂停
    Pillow_ScoreDeductibleType_HeartbeatLow,//心跳过缓
    Pillow_ScoreDeductibleType_HeartbeatHigh,//心跳过速
    Pillow_ScoreDeductibleType_BreathLow,//呼吸过缓
    Pillow_ScoreDeductibleType_BreathHight,//呼吸过速
    Pillow_ScoreDeductibleType_optimumSleepPercentTooLow,//良性睡眠比例低
